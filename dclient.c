 ...
 *
 * DESCRIPTION	: This will send the commands to the dserver which will return the appropriate results after
 *                            performing some operations in the dserver.
 *
 *
 *
 * EXECUTION		:	/fblient <IP> <PORT>
 *
