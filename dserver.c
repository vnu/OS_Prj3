 ...
 *
 * DESCRIPTION	: This will be the server that implements the simulated disk-storage system
 *
 * EXECUTION		:	./dserver <PORT> <Track> <Sectors> <filename>
 * <PORT> is the port # at IP to connect to
 * <Tracks> is the # of tracks on the disk being simulated
 * <Sectors> is the # of sectors per track
 * OPTIONAL: <filename> is the data file to use to store the simulated disk data. You can hardcode this into your code.
 ...
 */
    ...
    default :
    	/*sprintf(info,"%s","Command Error");
		write(client_sockfd, info, strlen(info) + 1);*/
