 ...
 *
 * DESCRIPTION	: This will send the commands to the fserver which will return the appropriate results after
 *                            performing some operations by contacting the dserver.
 *
 *
 *
 * EXECUTION		:	/fclient <IP> <PORT>
 *
